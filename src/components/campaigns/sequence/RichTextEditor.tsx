  ...
  return (
    <div className="relative w-full h-full">
      ...
      <ReactQuill
        ...
        className="w-full [&_.ql-container]:border [&_.ql-container]:border-border [&_.ql-container]:rounded-b-md [&_.ql-container]:border-t-0 [&_.ql-editor]:min-h-[150px] [&_.ql-tooltip]:!z-[9999] [&_.ql-tooltip]:!border-border [&_.ql-tooltip]:!bg-popover [&_.ql-tooltip]:!text-popover-foreground [&_.ql-tooltip]:!shadow-md [&_.ql-tooltip]:!rounded-md [&_.ql-tooltip]:!px-3 [&_.ql-tooltip]:!py-2 [&_.ql-tooltip.ql-editing]:!w-80 [&_.ql-tooltip]:!text-sm [&_.ql-tooltip_input]:!border-input [&_.ql-tooltip_input]:!bg-background [&_.ql-tooltip_input]:!h-9 [&_.ql-tooltip_input]:!rounded-md [&_.ql-tooltip_input]:!px-3 [&_.ql-tooltip_input]:!py-1 [&_.ql-tooltip_input]:!text-sm [&_.ql-tooltip_input]:!leading-none [&_.ql-tooltip_input]:!transition-colors [&_.ql-tooltip_input]:!w-full [&_.ql-tooltip_input:focus]:!outline-none [&_.ql-tooltip_input:focus]:!ring-1 [&_.ql-tooltip_input:focus]:!ring-ring [&_.ql-tooltip_a]:!text-primary [&_.ql-tooltip_a]:!no-underline [&_.ql-tooltip_a:hover]:!text-primary/80 [&_.ql-tooltip_a.ql-action]:!ml-0 [&_.ql-tooltip_a.ql-action]:!mr-2 [&_.ql-tooltip_a.ql-remove]:!ml-2 [&_.ql-tooltip_a.ql-remove]:!mr-0 [&_.ql-tooltip_a.ql-action]:!bg-primary [&_.ql-tooltip_a.ql-action]:!text-primary-foreground [&_.ql-tooltip_a.ql-action]:!px-4 [&_.ql-tooltip_a.ql-action]:!py-2 [&_.ql-tooltip_a.ql-action]:!rounded-md [&_.ql-tooltip_a.ql-action]:!text-sm [&_.ql-tooltip_a.ql-action]:!font-medium [&_.ql-tooltip_a.ql-action]:!inline-flex [&_.ql-tooltip_a.ql-action]:!items-center [&_.ql-tooltip_a.ql-action]:!justify-center [&_.ql-tooltip_a.ql-action]:!transition-colors [&_.ql-tooltip_a.ql-action]:hover:!bg-primary/90"
      />
    </div>
  );
}